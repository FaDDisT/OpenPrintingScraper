...
public final class OpenPrintingScraper {
    ...
    private OpenPrintingScraper(final HttpHost openPrintingHost) {
        this.openPrintingHost = openPrintingHost;
    }

    public static OpenPrintingScraper create(final HttpHost openPrintingTestHost) {
        return new OpenPrintingScraper(openPrintingTestHost);
    }

    protected List<Manufacturer> getManifacturers() throws IOException {
    ...
    protected List<Printer> getPrinters(final Manufacturer manufacturer) throws IOException {
